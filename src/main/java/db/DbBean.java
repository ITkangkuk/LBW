...
public class DbBean {
   ...
   public String getX_SWIFI_INSTL_FLOOR() {
      return this.X_SWIFI_INSTL_FLOOR;
   }
   ...
   public String getX_SWIFI_CNSTC_YEAR() {
      return this.X_SWIFI_CNSTC_YEAR;
   }
   ...
   public String getX_SWIFI_INOUT_DOOR() {
      return this.X_SWIFI_INOUT_DOOR;
   }
